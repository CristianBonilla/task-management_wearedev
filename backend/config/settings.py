...
MIGRATION_MODULES = {"tasks": "tasks.infrastructure.migrations"}
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "tasks.presentation.exception_handler.problem_details_handler",
...
EXPIRING_WINDOW_HOURS = env("EXPIRING_WINDOW_HOURS")
DEFAULT_TASK_OWNER = env("DEFAULT_TASK_OWNER")
